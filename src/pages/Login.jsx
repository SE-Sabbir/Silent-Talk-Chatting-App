...
const Login = () => {
  ...
  return (
    <>
      <section id="login" className="w-full h-screen bg-linear-to-tl from-[#fab2ff] to-[#1904e5] ">
          ...
          <div className="w-full h-[90%] flex justify-around items-center rounded-4xl bg-[#ececec]">
            ...
            <div className="flex-col justify-items-center p-[40px] rounded-[16px] bg-[#FFFFFF] shadow-2xl">
              <div className="form_header text-center">
                <h1 className="font-poppins font-bold text-[24px] text-primary">
                  User Login
                </h1>
                {/* -------------------Login Erorr show-------------------- */}
                <h2 className="font-poppins font-normal text-[14px] text-[#FF0000]">
                  {loginError}
                </h2>
              </div>
              <form onSubmit={handelLogin}>
                ...
                <div className="w-full flex-col justify-center pt-[20px] ">
                  <h2 className="font-poppins font-normal text-[14px] text-primary mb-[8px]">
                    E-mail
                  </h2>
                  <p className=" font-poppins font-light text-[12px] text-[#FF0000] pb-1 ">
                    {formData.emailError}{" "}
                  </p>
                  <div
                    className="userEmail w-[360px] h-[48px] font-poppins font-normal text-[14px] border border-[#E8EDF2] rounded-[15px] px-4 
                ...
                <div className="w-full flex-col justify-center pt-[20px]">
                  ...
                  <div
                    className="first_name w-[360px] h-[48px] font-poppins font-normal text-[14px] border border-[#E8EDF2] rounded-[15px] px-4 
                        flex justify-between items-center"
                  >
                    <input
                      onChange={(e) => {
                      ...
                      className="w-full outline-none"
                    />
                    <div className="text-[18px] text-iconcolor"></div>
                  </div>
                </div>
                <p className="flex justify-end font-poppins font-light text-[13px] text-primary pt-2 pr-2 ">
              ...
              <div className="w-full flex justify-center pt-[20px]">
                <h2 className="font-poppins font-normal text-[14px] text[#7A828A]">
                  Not Registered ?
                  <Link className="text-[#7364DB] pl-1 " to={"/register"}>
                    Create an Account
                  </Link>
                </h2>
              </div>
