      ...
      <div className="Chat_section flex flex-col w-full h-screen">
        ...
        <div className="flex items-center justify-between p-[15px]  bg-[#3e9cf3] shadow-2xl">
          <div className="flex items-center">
            ...
            <img src={profile1} alt="profile image" className=" w-full h-full " />
            </div>
        ...
        <div className="flex items-center p-3 border-t border-[#bdb8b8] bg-[#f5f3f3]">
          ...
          <input type="text" placeholder="Type a message" className="flex-1 outline-none p-2 border border-[#bdb8b8] rounded-full bg-[#ffffffc7]"/>
          <button className=" flex justify-center items-center mx-4 p-3 w-12 h-12 bg-[#0081FB] rounded-full text-white"><FiSend className=" text-[25px] text-[#FFFFFF] " /></button>
        </div>
      </div>
    </>
  )
